...
P10 adds sanitized fixtures from the 2026-06-25 built-dist smoke diagnostics.
These fixtures intentionally preserve the live selector gaps that the
2026-06-24 fixtures missed. DeepSeek, Tongyi/Qianwen, and Doubao remain pending
for P12; Perplexity is active after the P13 residual repair.
