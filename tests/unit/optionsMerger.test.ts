...
import type { StoredOptions, ReadingSessionOptions } from '../../src/shared/types';
  ...
  it('normalizes fragment modifier keys', () => {
    const stored: StoredOptions = {
      fragmentClipper: {
        ...
        selectionModifierKeys: ['meta', 'ctrl', 'cmd', 'Alt'] as unknown as string[]
      }
    };
