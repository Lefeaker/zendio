...
describe('TemplatesSection', () => {
  ...
  it('renders defaults and registers form section', () => {
    ...
    const articleInput = container.querySelector<HTMLInputElement>(
      'input[data-template-role="article"]'
    );
  ...
  it('collects template/domain mapping changes and persists via repository', async () => {
    ...
    const fragmentInput = container.querySelector<HTMLInputElement>(
      'input[data-template-role="fragment"]'
    );
