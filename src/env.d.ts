...
declare const __ZENDIO_GA_MEASUREMENT_ID__: string | undefined;
declare const __ZENDIO_GA_TRANSPORT_MODE__: string | undefined;
declare const __ZENDIO_GA_PROXY_ENDPOINT__: string | undefined;
