...
const runtime: Messages = {
  ...
  analyticsDebugDescription:
    'Когда включено, события проходят через настроенный отладочный прокси, а детали запросов записываются в консоль. Используйте только при устранении неполадок.',
