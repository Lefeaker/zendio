...
├── sections/        # legacy base-section blocker remains until the final Plan 07 milestone
...
- The old REST helper files under `sections/` were retired after current REST app/storage owners gained coverage. Do not restore them as compatibility shims.
