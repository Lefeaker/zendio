...
export const STANDARDIZED_ERROR_CODES = {
  ...
  EXTRACTION_AI_CHAT_PARSE_EMPTY: 'EXTRACTION_AI_CHAT_PARSE_EMPTY',
  EXTRACTION_AI_CHAT_PARSE_ROLE_INCOMPLETE: 'EXTRACTION_AI_CHAT_PARSE_ROLE_INCOMPLETE',
...
export const ERROR_CODE_DESCRIPTIONS: Record<StandardizedErrorCode, string> = {
  ...
  EXTRACTION_AI_CHAT_PARSE_EMPTY: 'AI chat parser produced no messages',
  EXTRACTION_AI_CHAT_PARSE_ROLE_INCOMPLETE: 'AI chat parser produced incomplete message roles',
