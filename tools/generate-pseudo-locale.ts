...
const OUTPUT_FILE = path.join(ROOT, 'src/i18n/generated/locales/qps-ploc.generated.ts');

function generateContent(): string {
  return `/* This file is generated by tools/generate-i18n-catalog.ts. Do not edit directly. */
