...
const MAX_LINE_BUDGETS = new Map([
  ...
  ['src/content/video/sessionOperations.ts', 587],
  ...
  ['src/content/video/videoSessionRuntime.ts', 434],
  ['src/content/reader/ui/ReaderDialogPanel.ts', 393],
  ['src/content/reader/session.ts', 398],
  ...
  ['src/shared/errors/analytics/analyticsConfig.template.ts', 371],
  ['src/shared/errors/analytics/analyticsConfig.ts', 370],
  ...
  ['src/content/reader/sessionOperations.ts', 397],
