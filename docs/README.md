...
- i18n production copy 当前不变量：production user-visible copy 只能来自 i18n catalog 或 `UserVisibleMessageDescriptor` key；background/content 边界传 descriptor/code/params；`quality` 已包含 `audit:i18n-hardcoded-user-copy:check` hard gate，当前 audit truth 为 `scanned=577 findings=19 unexpected=0 staleAllowlist=0`
