...
Zendio 的错误分析系统使用 Google Analytics 4 (GA4) 来收集匿名的错误数据。本指南将帮助你正确配置 GA4 集成。
...
2. **创建新属性**
   ...
   - 填写属性名称，例如："Zendio Extension Analytics"
...
配置完成后，你的 Zendio 扩展就具备了完整的错误分析能力，可以帮助你更好地了解和改进扩展的稳定性！
