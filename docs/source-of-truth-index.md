...
- 2026-05-26 M10 scoped type audit truth：2026-05-28 post-gap integration current overall `0/994/1674/108/5`；src `0/553/623/5/0`；tests `0/441/1052/103/5`；`lint:type-any:ratchet` 必须同时守住 overall、src 与 tests，tests 下降不得抵消 src 增长
...
- 2026-05-26 M10 budget ratchet truth：`lint:type-any:ratchet` 以 overall `0/994/1674/108/5`、src `0/553/623/5/0`、tests `0/441/1052/103/5` 接入 `quality`；`audit:performance:report` 动态发现当前全部 `100` 个 `src` >250 LOC 文件并要求每个文件存在 line budget
