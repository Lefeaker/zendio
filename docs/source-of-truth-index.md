...
- 2026-05-24 M3.1 type audit truth：`lint:type-any` 扫描 `1066` files；`any: 12`、`unknown: 1091`、assertions `1849`、non-null assertions `129`、`ts-expect-error: 5`；`scripts/audit-types.mjs` 阈值门禁参数以该 truth 为当前上限
