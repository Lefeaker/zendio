...
- 2026-05-26 M10 scoped type audit truth：当前 2026-06-04 i18n-v2 M11 integration 为 overall `0/991/1658/41/4`；src `0/549/579/5/0`；tests `0/442/1079/36/4`；`lint:type-any:ratchet` 必须同时守住 overall、src 与 tests，tests 下降不得抵消 src 增长
...
- 2026-05-26 M10 budget ratchet truth：`lint:type-any:ratchet` 以当前 overall `0/991/1658/41/4`、src `0/549/579/5/0`、tests `0/442/1079/36/4` 接入 `quality`；`audit:performance:report` 动态发现当前全部 `93` 个 `src` >250 LOC 文件并要求每个文件存在 line budget
