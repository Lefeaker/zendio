...
- 2026-05-26 M10 budget ratchet truth：`lint:type-any:ratchet` 以当前 overall `0/1064/1736/41/4`、src `0/576/596/5/0`、tests `0/488/1140/36/4` 接入 `quality`；`audit:performance:report` 动态发现当前全部 `93` 个 `src` >250 LOC 文件并要求每个文件存在 line budget
