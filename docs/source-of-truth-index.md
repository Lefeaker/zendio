...
- 2026-05-26 M10 scoped type audit truth：2026-05-28 post-gap integration current overall `0/970/1663/108/5`；src `0/539/623/5/0`；tests `0/431/1040/103/5`；`lint:type-any:ratchet` 必须同时守住 overall、src 与 tests，tests 下降不得抵消 src 增长
...
- 2026-05-26 M10 budget ratchet truth：`lint:type-any:ratchet` 以 overall `0/970/1663/108/5`、src `0/539/623/5/0`、tests `0/431/1040/103/5` 接入 `quality`；`audit:performance:report` 动态发现当前全部 `99` 个 `src` >250 LOC 文件并要求每个文件存在 line budget
