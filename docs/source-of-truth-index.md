...
- 2026-05-24 gap-remediation baseline sync 真值：lint warning baseline 曾同步为 `254`；2026-05-26 M10 后 baseline 收紧为 `159`；2026-05-28 Plan 09 后 baseline 收紧为 `141`；2026-06-01 Plan 06 section retirement 后 baseline 为 `137`；2026-06-01 Plan 03 native YAML retirement 后 checked-in baseline 仍为 `132`，而 2026-06-05 fresh warning count 已下降到 `127`；在 owner 有意同步 baseline 前，不得通过禁用规则或修改 lint 配置制造下降
