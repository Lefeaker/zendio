...
- 2026-06-03 video-mode structural repair type-ratchet truth：P01-P06 合入后，`lint:type-any:ratchet` 当前守住 overall `0/971/1616/41/4`、src `0/537/565/5/0`、tests `0/434/1051/36/4`；本次只同步 current truth，没有放宽 `any` 或 `ts-expect-error` 上限，并收紧 overall assertions/non-null 与 src unknown/assertion 上限
...
- 2026-05-26 M10 scoped type audit truth：当前 2026-06-03 video-mode structural repair integration 为 overall `0/971/1616/41/4`；src `0/537/565/5/0`；tests `0/434/1051/36/4`；`lint:type-any:ratchet` 必须同时守住 overall、src 与 tests，tests 下降不得抵消 src 增长
...
- 2026-05-26 M10 budget ratchet truth：`lint:type-any:ratchet` 以当前 overall `0/971/1616/41/4`、src `0/537/565/5/0`、tests `0/434/1051/36/4` 接入 `quality`；`audit:performance:report` 动态发现当前全部 `93` 个 `src` >250 LOC 文件并要求每个文件存在 line budget
