...
const LINT_REPORT_PATH = path.join(ROOT_DIR, 'lint-report.json');
const SUMMARY_PATH = path.join(ROOT_DIR, 'lint-warnings.json');
...
async function generateReport() {
  ...
  console.log(`✅ 生成完成：${summary.totalWarnings} 条 warning 已写入 lint-warnings.json`);
