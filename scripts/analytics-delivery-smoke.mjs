...
function normalizeOwnerProxyEndpoint(value) {
  ...
  try {
    ...
    if (isGoogleMeasurementProtocolHost(url.hostname)) {
      return undefined;
    }
 ...
 * @returns {boolean}
 */
function isGoogleMeasurementProtocolHost(hostname) {
  const normalized = hostname.toLowerCase();
  return (
    normalized === 'google-analytics.com' ||
    normalized === 'www.google-analytics.com' ||
    normalized.endsWith('.google-analytics.com')
  );
}
