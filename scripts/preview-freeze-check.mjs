...
const ALLOWED_PREVIEW_DRIFT = new Map([
  ...
  [
    'original reference index.js vs current generated preview index.js',
    {
      ...
      // 2026-06-20 contextual legal contact links and privacy consent persistence preview JS hash.
      rightSha256: 'bde9b904e9708651474e806ce33c2be3b9bd0cc2da6b5ebf8e10445772d90138'
    }
  ]
]);
