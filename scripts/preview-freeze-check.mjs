  ...
  [
    'original reference index.js vs current generated preview index.js',
    {
      reason: [
        ...
        'The video screenshot export-state repair refreshes the generated preview JS hash after threading explicit off/pending/on screenshot state through the Video runtime surface and Stitch timestamp marker schema while preserving the frozen reference, existing toggle geometry, and export-without-recapture contract.'
      ].join(' '),
      leftSha256: '9020ccbd91acd691eccd3fdf568b9a90efbddf0a35d79f36ef1caba702fa0c07',
      // Video screenshot export-state repair: hash refreshed after explicit pending/on/off state output.
      rightSha256: '2c5e11e8ece1ae17b0b563f58ba714d2543bea8bb2d861d19001a1ce083692d9'
    }
  ]
]);
