...
const ALLOWED_PREVIEW_DRIFT = new Map([
  ...
  [
    'original reference index.js vs current generated preview index.js',
    {
      ...
      // 2026-06-19 onboarding platform connection and shared resource modal preview JS hash.
      rightSha256: '57d1b1aef29d81c27d9d855ed2f1b48b614adf4aafadcb4aabca15b419582aea'
    }
  ]
]);
