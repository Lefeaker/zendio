  ...
  [
    'original reference index.js vs current generated preview index.js',
    {
      reason: [
        ...
        'Zendio 0.2.0 hides Advanced Connection Schema and Output Presets from Options, refreshing the generated preview JS hash while preserving the frozen reference and underlying storage/preset logic.'
      ].join(' '),
      leftSha256: '9020ccbd91acd691eccd3fdf568b9a90efbddf0a35d79f36ef1caba702fa0c07',
      // Zendio 0.2.0: hash refreshed after hiding Advanced Connection Schema and Output Presets from Options.
      rightSha256: '0ff0f88f93fd4079fbcf911e25b3a913aecf9a73ed75683337806a05f34f27b3'
    }
  ]
]);
