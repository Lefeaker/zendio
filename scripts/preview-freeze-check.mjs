  ...
  [
    'original reference index.js vs current generated preview index.js',
    {
      reason: [
        ...
        'The PR #26 main sync refreshes the generated preview JS hash after combining the accepted video screenshot attachment location controls with the Options fragment modifier and Vault guidance runtime while preserving the frozen reference and Stitch runtime contract. The P14 final integration refreshes the generated preview JS hash after accepted i18n finalization, stop-unknown orphan deletion, dependency-cruiser cycle repair, and lint-only callback/parser tightening while preserving the frozen reference and Stitch runtime contract. The video attachment layout i18n sync refreshes the generated preview JS hash after merging the accepted Options 12-language catalog baseline with the video entry/attachment path layout, hiding Output Presets, splitting the capture-sources video schema helper, and removing unnecessary helper-local type assertions while preserving the frozen reference and Stitch runtime contract.',
      ...
      // Post-audit Options i18n repair: hash refreshed after accepted changelog and nav-hint localization repair.
      rightSha256: '7e68e8264002e50b36508f09a3b17e355c50e4abd73abb3258ac66d114aad82e'
    }
  ]
]);
