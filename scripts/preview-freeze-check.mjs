  ...
  [
    'original reference index.js vs current generated preview index.js',
    {
      reason: [
        ...
        'Zendio 0.2.0 hides Advanced Connection Schema and Output Presets from Options, refreshing the generated preview JS hash while preserving the frozen reference and underlying storage/preset logic. The Options UI closeout refreshes the generated preview JS hash after changing Local Folder deletion from a popover to an in-place delete state, moving Video Prompt & Entry switches into body rows, and making sidebar navigation set the main scroller immediately while preserving the frozen reference and Stitch runtime contract. The accepted video screenshot attachment location follow-up refreshes the generated preview JS hash after adding the Options controls, nested video screenshot attachment state wiring, and screenshot attachment copy needed for the feature while preserving the frozen reference and Stitch runtime contract.'
      ].join(' '),
      leftSha256: '9020ccbd91acd691eccd3fdf568b9a90efbddf0a35d79f36ef1caba702fa0c07',
      // Video screenshot attachment location: hash refreshed after accepted Options controls/state wiring and copy changes.
      rightSha256: '3e4682aa3cf073a1719b60fd9a92e13a9c659917247772752eb8a22140727c30'
    }
  ]
]);
