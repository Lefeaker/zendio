  ...
  [
    'original reference index.js vs current generated preview index.js',
    {
      reason: [
        ...
        'Zendio 0.2.0 hides Advanced Connection Schema and Output Presets from Options, refreshing the generated preview JS hash while preserving the frozen reference and underlying storage/preset logic. The Options UI closeout refreshes the generated preview JS hash after changing Local Folder deletion from a popover to an in-place delete state, moving Video Prompt & Entry switches into body rows, and making sidebar navigation set the main scroller immediately while preserving the frozen reference and Stitch runtime contract. The accepted video screenshot attachment location follow-up refreshes the generated preview JS hash after adding the Options controls, nested video screenshot attachment state wiring, and screenshot attachment copy needed for the feature while preserving the frozen reference and Stitch runtime contract. The final integration ratchet repair refreshes the generated preview JS hash after removing accepted feature-local unknown/cast debt and restoring the planner hotspot line budget without changing the frozen reference or Stitch runtime contract.'
      ].join(' '),
      leftSha256: '9020ccbd91acd691eccd3fdf568b9a90efbddf0a35d79f36ef1caba702fa0c07',
      // Video screenshot attachment location: hash refreshed after accepted ratchet-safe follow-up cleanup.
      rightSha256: 'eb4b11811c510e32ce5e0058c8e6c6b9d7f33ac76662382031d40559013d33ff'
    }
  ]
]);
